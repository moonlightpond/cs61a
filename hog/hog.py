...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            tell = extra_turn(score0, score1)
        else:
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            tell = extra_turn(score1, score0) 
        if not tell:
            who = other(who)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        if who == 1:
            d = score1 - last_score
            if d > running_high:
                print(d, "point(s)! The most yet for Player 1")
                return announce_highest(who, score1, d)
            else:
                return announce_highest(who, score1, running_high)
        if who == 0:
            d = score0 - last_score
            if d > running_high:
                print(d, "point(s)! The most yet for Player 0")
                return announce_highest(who, score0, d)
            else:
