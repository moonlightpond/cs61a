...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.n == 0:
            ...
            d1 = self.price-self.funds
            return f'Please add ${d1} more funds.'
        elif self.funds == self.price:
            self.n -= 1
            self.funds = 0
            ...
            self.n -= 1
            d2 = self.funds - self.price
            self.funds = 0
            return f'Here is your {self.product} and ${d2} change.'
